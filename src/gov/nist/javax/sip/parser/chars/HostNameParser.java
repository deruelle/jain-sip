...
public class HostNameParser extends ParserCore {
    ...
    public Host host() throws ParseException {
        ...
        try {
            ...
            else if( isIPv6Address(lexer.getRest()) )
            {
                ...
                hostname
                    = new StringBuilder("[").append(
                        lexer.getSubBuffer(startPtr, lexer.getPtr()))
                        .append("]").toString();
            }
            //IPv4 address or hostname
                ...
                int startPtr = lexer.getPtr();
                consumeDomainLabel();
                hostname = String.valueOf(lexer.getSubBuffer(startPtr, lexer.getPtr()));
            }
    ...
    public static void main(String args[]) throws ParseException {
        ...
        for (int i = 0; i < hostNames.length; i++) {
            try {
                HostNameParser hnp = new HostNameParser(hostNames[i].toCharArray());
